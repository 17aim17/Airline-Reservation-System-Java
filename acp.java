...
public class acp extends JInternalFrame implements ActionListener{
...
acp(){
  ...
  super("Admin Change Password",true,true,true,true);
  setSize(1366,712);
  pn =new JPanel();
  lb4 =new JLabel("Chage Password");
...
public void actionPerformed(ActionEvent e)
{
      ...
      {
          JOptionPane.showMessageDialog(this,"Sorry , cannot change password at this moment");
      }
}
